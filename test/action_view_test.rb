...
class ActionViewTest < Minitest::Test
  ...
  def test_render_with_vars
    template = ActionView::Template.new("<p><%= @var %></p>", "test_render_template")
  ...
  def test_render_with_yield
    template = ActionView::Template.new("<p><%= yield %></p>", "test_render_template")
  ...
  def test_render_with_helper
    template = ActionView::Template.new("<%= link_to 'title', '/url' %>", "test_render_template")
